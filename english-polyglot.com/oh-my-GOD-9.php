...
//        'https://translate.google.com/translate_tts?ie=UTF-8&tl='. $langen .'&q='. urlencode($texten) .'&total=1&idx=0&textlen=5&prev=input&tk=995126.592330&client=t');
//		
//        file_put_contents($dirfileen, $mp3);

		$url = 'http://translate.google.com/translate_tts?ie=UTF-8&tl='. $langen .'&q='. urlencode($texten) .'&tk=995126.592330&client=t';
		downloadMP3( $url, $dirfileen );
    }
	else {echo " hii <br />";}
	...
	if (!file_exists($fileru))
    {
        ...
        // Download the content
//        $mp3 = file_get_contents(
//        'https://translate.google.com/translate_tts?tl='. $langru .'&q='. urlencode($textru) .'&total=1&idx=0&textlen=5&prev=input&tk=995126.592330&client=t');
//		
//        file_put_contents($dirfileru, $mp3);
		
		$url = 'http://translate.google.com/translate_tts?ie=UTF-8&tl='. $langru .'&q='. urlencode($textru) .'&tk=995126.592330&client=t';
		downloadMP3( $url, $dirfileru );
    }
	else {echo " hii <br />";}
...
//	echo $ourFileHandle;
    ...
    if (!file_exists($fileen))
    {
        ...
        // Download the content
//        $mp3 = file_get_contents(
//        'https://translate.google.com/translate_tts?tl='. $langen .'&q='. urlencode($texten) .'&total=1&idx=0&textlen=5&prev=input&tk=995126.592330&client=t');
