...
//	echo $ourFileHandle;
    ...
    if (!file_exists($fileen))
    {
        ...
        'http://translate.google.com/translate_tts?key=AIzaSyAKerozKf73Wp5PS2iJ3PVbS7ZUcRUei-4&ie=UTF-8&q='. urlencode($texten) .'&tl='. $langen .'&total=1&idx=0&textlen=5&prev=input');
	...
	if (!file_exists($fileru))
    {
        ...
        // Download the content
        $mp3 = file_get_contents(
        'http://translate.google.com/translate_tts?key=AIzaSyAKerozKf73Wp5PS2iJ3PVbS7ZUcRUei-4&ie=UTF-8&q='. urlencode($textru) .'&tl='. $langru .'&total=1&idx=0&textlen=5&prev=input');
