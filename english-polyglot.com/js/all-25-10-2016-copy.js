function popup(url, width, height, windowtitle, textdescription, pronunciation) 
{
		...
		if (ua.match(/iPhone|iPod|Android|Blackberry.*WebKit/i)) 
		{
			...
			if (url=="")
			{
				...
				newwin.onload = function() 
				{
					 ...
					 newwin.document.getElementById('content_answer').innerHTML = '<div style="font-family: Arial, Helvetica, sans-serif; font-size:150%;text-align:center;margin-top:0.5em"><div style="background:url(img/li-uncolorer-rt.gif) no-repeat right top #e5f2ee;">'+
	  ...
	  newwin.document.getElementById('button_answer').innerHTML = '<form style="text-align:center;margin:2em">'+
	  '<input style="font-size:150%;" type="button" value="   Done   " onClick="window.close();return false;"></form>';
				}
			...
			{						
				if((getextension(url)=='jpg')||(getextension(url)=='gif')||(getextension(url)=='png'))
				{
					...
					{					
						...
						newwin.document.getElementById('content_answer').innerHTML = '<img src="'+url+
					 '" style="height:100%">';
	  					newwin.document.getElementById('button_answer').innerHTML = '<form style="text-align:center;margin:2em">'+
	  '<input style="font-size:150%;" type="button" value="   Done   " onClick="window.close();return false;"></form>';
					}										
		...
		{						
			...
			{	 
				   ...
				   '<body onblur="self.onblur();" style="font-family: Arial, Helvetica, sans-serif; font-size:100%; text-align:center;">'+
		  ...
		  '</div><div><strong>'+textdescription+'</strong></div><div>'+pronunciation+'</div>'+
		  '<img src="img/x.gif" width="1" height="10" /></div></div></div>'+
		  '<form style="text-align:center;margin:2em">'+
		  '<input type="button" value="   Done   " onClick="window.close();return false;"></form>'+
				   '</body></html>');
