...
function(r) {
    if (!window.JSON) {
        var t, n = Object.prototype.toString, e = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, o = {
            "\b": "\\b",
            "	": "\\t",
            "\n": "\\n",
            "\f": "\\f",
        ...
        window.JSON = {
            stringify: t = function(i) {
                ...
                case "[object String]":
                    ...
                    '"' + (e.test(i) ? i.replace(e, function(r) {
                        var t = o[r];
                ...
                case "[object Object]":
                    ...
                    f = 0;
                    for (var l in i)
                        i.hasOwnProperty(l) && (a = t(i[l]),
                        "undefined" != typeof a && (u += (f++ ? "," : "") + '"' + l + '":' + a));
                    return u + "}";
                default:
                    return r
                }
...
String.prototype.trim || (String.prototype.trim = function() {
    for (var r = this.replace(/^\s\s*/, ""), t = /\s/, n = r.length; t.test(r.charAt(--n)); )
        ;
