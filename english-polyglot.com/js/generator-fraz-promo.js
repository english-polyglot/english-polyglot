...
lib.ssMetadata = [
		{name:"generator_fraz_promo_atlas_1", frames: [[0,0,1121,1500]]},
		{name:"generator_fraz_promo_atlas_2", frames: [[422,1528,453,454],[1123,634,420,588],[0,1528,420,517],[1545,634,420,588],[1123,1224,791,302],[1423,1528,420,446],[1123,0,659,632],[877,1528,544,372],[0,0,1121,1500]]},
		{name:"generator_fraz_promo_atlas_3", frames: [[858,598,18,29],[890,566,21,41],[677,566,63,59],[1834,497,45,41],[1081,633,120,120],[1203,633,93,93],[1298,633,93,93],[1457,0,558,248],[693,193,717,189],[1277,1653,420,92],[271,384,729,180],[0,1369,420,163],[1081,804,420,234],[1412,250,420,305],[271,0,420,376],[913,566,27,28],[2038,140,7,7],[942,566,27,27],[0,1534,420,21],[971,566,26,27],[64,645,18,37],[2036,232,12,39],[742,566,31,38],[2017,232,13,4],[942,595,20,34],[804,566,26,37],[1412,193,42,44],[2004,497,32,37],[832,566,24,39],[2036,273,12,39],[99,645,18,27],[858,566,30,30],[119,645,11,36],[2038,149,7,7],[913,596,25,27],[1963,497,39,38],[775,566,27,40],[964,595,26,26],[1881,497,39,39],[1922,497,39,39],[1277,1529,436,122],[1894,1035,126,344],[0,1616,436,122],[397,880,399,240],[1002,384,407,247],[0,1060,369,245],[677,633,402,245],[1411,557,405,245],[798,1040,380,243],[271,566,404,245],[1503,1035,389,245],[0,813,395,245],[1519,1282,321,245],[1180,1282,337,245],[371,1122,356,245],[729,1285,303,245],[1180,1040,283,240],[1834,250,200,245],[1842,1381,178,239],[876,1532,156,241],[1818,557,220,245],[422,1369,262,245],[1929,804,116,227],[596,1616,79,210],[1034,1529,241,241],[1034,1285,136,237],[1877,1622,48,175],[1813,1622,62,194],[1503,804,424,229],[0,0,269,643],[686,1532,188,213],[438,1616,156,241],[1715,1529,96,218],[693,0,762,191],[0,645,37,154],[39,645,23,114],[2017,0,28,138],[1393,633,16,74],[2036,314,12,25],[2017,140,19,90],[84,645,13,41],[2017,238,11,1]]}
];
...
(lib.CachedBmp_93 = function() {
	this.initialize(ss["generator_fraz_promo_atlas_3"]);
	this.gotoAndStop(0);
...
(lib.generatorfrazpromo = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(982.6,32.05,0.5,0.5);
	...
	this.bigStop.setTransform(1261.4,407.05,0.2495,1,0,0,0,1069.8,604.5);
	...
	this.videoplay.setTransform(1668.65,386);
	...
	this.instance_1.setTransform(1501,689,0.69,0.69,0,0,0,26.4,81);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1232).to({_off:false},0).wait(1).to({regX:26.5,rotation:0.701,y:687.95},0).wait(1).to({rotation:2.8698,x:1500.9,y:684.8},0).wait(1).to({rotation:6.4624,x:1500.7,y:679.65},0).wait(1).to({rotation:11.479,x:1500.4,y:672.45},0).wait(1).to({rotation:17.9414,x:1500,y:663.3},0).wait(1).to({rotation:25.8497,x:1499.4,y:652.15},0).wait(1).to({rotation:35.1818,x:1498.55,y:639.25},0).wait(1).to({rotation:45.9598,x:1497.45,y:624.45},0).wait(1).to({rotation:58.1618,x:1496.15,y:608.05},0).wait(1).to({rotation:71.8095,x:1494.4,y:589.95},0).wait(1).to({rotation:86.9031,x:1492.3,y:570.4},0).wait(1).to({rotation:103.4206,x:1489.7,y:549.6},0).wait(1).to({rotation:121.362,x:1486.6,y:527.5},0).wait(1).to({rotation:140.7712,x:1482.8,y:504.4},0).wait(1).to({rotation:161.6043,x:1478.35,y:480.4},0).wait(1).to({rotation:173.9525,x:1473.15,y:455.8},0).wait(1).to({rotation:170.3747,x:1467.1,y:430.7},0).wait(1).to({rotation:166.582,x:1460.25,y:405.35},0).wait(1).to({rotation:162.5677,x:1452.4,y:379.9},0).wait(1).to({rotation:158.3418,x:1443.5,y:354.65},0).wait(1).to({rotation:153.8944,x:1433.65,y:329.85},0).wait(1).to({rotation:149.2353,x:1422.6,y:305.9},0).wait(1).to({rotation:144.3547,x:1410.5,y:282.85},0).wait(1).to({rotation:139.2592,x:1397.15,y:261.2},0).wait(1).to({rotation:133.9487,x:1382.7,y:241.15},0).wait(1).to({rotation:128.42,x:1367.1,y:223.2},0).wait(1).to({rotation:122.6731,x:1350.4,y:207.6},0).wait(1).to({rotation:116.7112,x:1332.5,y:194.75},0).wait(1).to({rotation:110.5311,x:1313.65,y:184.95},0).wait(1).to({rotation:104.1328,x:1293.85,y:178.8},0).wait(1).to({rotation:97.5757,x:1273.4,y:176.7},0).wait(1).to({rotation:91.1773,x:1253.3,y:178.7},0).wait(1).to({rotation:84.9972,x:1234.15,y:184.45},0).wait(1).to({rotation:79.0353,x:1215.85,y:193.75},0).wait(1).to({rotation:73.2884,x:1198.4,y:206.05},0).wait(1).to({rotation:67.7597,x:1182.05,y:221.1},0).wait(1).to({rotation:62.4492,x:1166.8,y:238.55},0).wait(1).to({rotation:57.3537,x:1152.6,y:258.05},0).wait(1).to({rotation:52.4731,x:1139.5,y:279.25},0).wait(1).to({rotation:47.814,x:1127.45,y:301.85},0).wait(1).to({rotation:43.3666,x:1116.4,y:325.55},0).wait(1).to({rotation:39.1407,x:1106.45,y:350},0).wait(1).to({rotation:35.1265,x:1097.45,y:374.95},0).wait(1).to({rotation:31.3337,x:1089.4,y:400.2},0).wait(1).to({rotation:27.7559,x:1082.25,y:425.4},0).wait(1).to({rotation:24.3964,x:1075.95,y:450.35},0).wait(1).to({rotation:21.2518,x:1070.45,y:474.9},0).wait(1).to({rotation:18.3221,x:1065.65,y:498.6},0).wait(1).to({rotation:15.614,x:1061.45,y:521.45},0).wait(1).to({rotation:13.1208,x:1057.9,y:543.15},0).wait(1).to({rotation:10.8425,x:1054.95,y:563.6},0).wait(1).to({rotation:8.7824,x:1052.35,y:582.6},0).wait(1).to({rotation:6.9406,x:1050.3,y:599.95},0).wait(1).to({rotation:5.3138,x:1048.55,y:615.65},0).wait(1).to({rotation:3.9051,x:1047.15,y:629.4},0).wait(1).to({rotation:2.7114,x:1046,y:641.3},0).wait(1).to({rotation:1.736,x:1045.2,y:651.1},0).wait(1).to({rotation:0.9788,x:1044.55,y:658.8},0).wait(1).to({rotation:0.4365,x:1044.1,y:664.4},0).wait(1).to({rotation:0.1091,x:1043.85,y:667.75},0).wait(1).to({rotation:0.0033,x:1043.8,y:668.85},0).wait(1).to({regY:81.1,rotation:0},0).to({_off:true},1).wait(32));

	// play_pause
	this.pausing = new lib.play_pause();
	this.pausing.name = "pausing";
	this.pausing.setTransform(1446.35,69,0.45,0.45,0,0,0,23.4,23.2);
	...
	this.again.setTransform(1511.35,69,0.0806,0.0806,0,0,0,113,113.5);
	...
	this.mutte.setTransform(1479.4,68.95,1,1,0,0,0,10.1,10.3);

	this.timeline.addTween(cjs.Tween.get(this.mutte).wait(1327));

	// hat
	this.instance_2 = new lib.CachedBmp_142();
	this.instance_2.setTransform(1166.25,345.1,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_143();
	this.instance_3.setTransform(1166.2,333.75,0.5,0.5);

	this.instance_4 = new lib.CachedBmp_144();
	this.instance_4.setTransform(1166.2,325.9,0.5,0.5);

	this.instance_5 = new lib.CachedBmp_145();
	this.instance_5.setTransform(1166.2,312.35,0.5,0.5);

	this.instance_6 = new lib.CachedBmp_146();
	this.instance_6.setTransform(1166.2,302,0.5,0.5);

	this.instance_7 = new lib.CachedBmp_147();
	this.instance_7.setTransform(1166.2,291.2,0.5,0.5);

	this.instance_8 = new lib.CachedBmp_148();
	this.instance_8.setTransform(1166.2,280.1,0.5,0.5);

	this.instance_9 = new lib.CachedBmp_149();
	this.instance_9.setTransform(1166.2,269.8,0.5,0.5);

	this.instance_10 = new lib.CachedBmp_150();
	this.instance_10.setTransform(1166.2,260.55,0.5,0.5);

	this.instance_11 = new lib.CachedBmp_151();
	this.instance_11.setTransform(1166.2,252,0.5,0.5);

	this.instance_12 = new lib.CachedBmp_152();
	this.instance_12.setTransform(1166.2,244.05,0.5,0.5);

	this.instance_13 = new lib.CachedBmp_153();
	this.instance_13.setTransform(1166.2,238.3,0.5,0.5);

	this.instance_14 = new lib.CachedBmp_154();
	this.instance_14.setTransform(1166.2,233.55,0.5,0.5);

	this.instance_15 = new lib.CachedBmp_155();
	this.instance_15.setTransform(1166.2,230.65,0.5,0.5);

	this.instance_16 = new lib.CachedBmp_156();
	this.instance_16.setTransform(1166.2,228.55,0.5,0.5);

	this.instance_17 = new lib.CachedBmp_157();
	this.instance_17.setTransform(1166.2,228.55,0.5,0.5);

	this.instance_18 = new lib.CachedBmp_158();
	this.instance_18.setTransform(1166.2,227.35,0.5,0.5);

	this.instance_19 = new lib.CachedBmp_159();
	this.instance_19.setTransform(1166.2,226.65,0.5,0.5);

	this.instance_20 = new lib.CachedBmp_160();
	this.instance_20.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_21 = new lib.CachedBmp_161();
	this.instance_21.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_22 = new lib.CachedBmp_162();
	this.instance_22.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_23 = new lib.CachedBmp_163();
	this.instance_23.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_24 = new lib.CachedBmp_164();
	this.instance_24.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_25 = new lib.CachedBmp_165();
	this.instance_25.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_26 = new lib.CachedBmp_166();
	this.instance_26.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_27 = new lib.CachedBmp_167();
	this.instance_27.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_28 = new lib.CachedBmp_168();
	this.instance_28.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_29 = new lib.CachedBmp_169();
	this.instance_29.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_30 = new lib.CachedBmp_170();
	this.instance_30.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_31 = new lib.CachedBmp_171();
	this.instance_31.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_32 = new lib.CachedBmp_172();
	this.instance_32.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_33 = new lib.CachedBmp_173();
	this.instance_33.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_34 = new lib.CachedBmp_174();
	this.instance_34.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_35 = new lib.CachedBmp_175();
	this.instance_35.setTransform(1166.2,226.6,0.5,0.5);

	this.instance_36 = new lib.CachedBmp_178();
	this.instance_36.setTransform(1166.2,226.6,0.5,0.5);
	...
	this.instance_37.setTransform(1262.55,431.5,0.6736,0.6736,0,0,0,424.9,499.7);
	this.instance_37.alpha = 0.0195;
	this.instance_37._off = true;

	this.duga = new lib.urlpsd();
	this.duga.name = "duga";
	this.duga.setTransform(1262.65,431.5,0.6736,0.6736,0,0,0,424.7,499.7);
	this.duga.alpha = 0;
	this.duga._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_37).wait(1265).to({_off:false},0).wait(1).to({regX:426,regY:246.5,x:1263.25,y:260.9,alpha:0.0526},0).wait(1).to({alpha:0.0853},0).wait(1).to({alpha:0.1179},0).wait(1).to({alpha:0.1505},0).wait(1).to({alpha:0.1832},0).wait(1).to({alpha:0.2158},0).wait(1).to({alpha:0.2484},0).wait(1).to({alpha:0.2811},0).wait(1).to({alpha:0.3137},0).wait(1).to({alpha:0.3463},0).wait(1).to({alpha:0.3789},0).wait(1).to({alpha:0.4116},0).wait(1).to({alpha:0.4442},0).wait(1).to({alpha:0.4768},0).wait(1).to({alpha:0.5095},0).wait(1).to({alpha:0.5421},0).wait(1).to({alpha:0.5747},0).wait(1).to({alpha:0.6074},0).wait(1).to({alpha:0.64},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regY:499.7,x:1262.6,y:431.5,alpha:0.6406,mode:"independent"},0).to({_off:true},22).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.duga).wait(1317).to({_off:false},0).wait(1).to({regX:426,regY:246.5,x:1263.45,y:260.9,alpha:0.0711},0).wait(1).to({alpha:0.1422},0).wait(1).to({alpha:0.2133},0).wait(1).to({alpha:0.2844},0).wait(1).to({alpha:0.3556},0).wait(1).to({alpha:0.4267},0).wait(1).to({alpha:0.4978},0).wait(1).to({alpha:0.5689},0).wait(1).to({alpha:0.64},0).wait(1));

	// Level_1
	this.instance_38 = new lib.face_vs_brain("synched",0);
	this.instance_38.setTransform(1271.45,461.1,0.3731,0.3731,0,0,0,425.9,499.6);

	this.instance_39 = new lib.urlpsd("synched",0);
	this.instance_39.setTransform(1271.65,461.5,0.3731,0.3731,0,0,0,425.4,499.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_39).wait(1196).to({_off:false},0).wait(1).to({regX:426,regY:246.5,scaleX:0.402,scaleY:0.402,x:1271,y:356.85},0).wait(1).to({scaleX:0.4288,scaleY:0.4288,x:1270.25,y:347.4},0).wait(1).to({scaleX:0.4534,scaleY:0.4534,x:1269.5,y:338.65},0).wait(1).to({scaleX:0.4762,scaleY:0.4762,x:1268.85,y:330.7},0).wait(1).to({scaleX:0.4971,scaleY:0.4971,x:1268.2,y:323.3},0).wait(1).to({scaleX:0.5163,scaleY:0.5163,x:1267.65,y:316.45},0).wait(1).to({scaleX:0.534,scaleY:0.534,x:1267.1,y:310.25},0).wait(1).to({scaleX:0.5501,scaleY:0.5501,x:1266.65,y:304.6},0).wait(1).to({scaleX:0.5648,scaleY:0.5648,x:1266.2,y:299.35},0).wait(1).to({scaleX:0.5782,scaleY:0.5782,x:1265.8,y:294.7},0).wait(1).to({scaleX:0.5904,scaleY:0.5904,x:1265.45,y:290.35},0).wait(1).to({scaleX:0.6015,scaleY:0.6015,x:1265.1,y:286.45},0).wait(1).to({scaleX:0.6115,scaleY:0.6115,x:1264.85,y:282.95},0).wait(1).to({scaleX:0.6205,scaleY:0.6205,x:1264.6,y:279.7},0).wait(1).to({scaleX:0.6286,scaleY:0.6286,x:1264.35,y:276.85},0).wait(1).to({scaleX:0.6359,scaleY:0.6359,x:1264.1,y:274.25},0).wait(1).to({scaleX:0.6425,scaleY:0.6425,x:1263.95,y:271.95},0).wait(1).to({scaleX:0.6483,scaleY:0.6483,x:1263.75,y:269.9},0).wait(1).to({scaleX:0.6535,scaleY:0.6535,x:1263.65,y:268.1},0).wait(1).to({scaleX:0.6581,scaleY:0.6581,x:1263.5,y:266.45},0).wait(1).to({scaleX:0.6621,scaleY:0.6621,x:1263.35,y:265.05},0).wait(1).to({scaleX:0.6657,scaleY:0.6657,x:1263.2,y:263.8},0).wait(1).to({scaleX:0.6688,scaleY:0.6688,x:1263.15,y:262.7},0).wait(1).to({scaleX:0.6715,scaleY:0.6715,x:1263.05,y:261.7},0).wait(1).to({scaleX:0.6736,scaleY:0.6736,x:1263,y:261},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:425.4,regY:499.8,x:1262.6,y:431.5,alpha:0.6406},0).to({_off:true},16).wait(62));

	// rise_up_face
	this.instance_40 = new lib.rise_up_face("synched",0);
	this.instance_40.setTransform(1270.6,412.95,1,1,0,0,0,142.6,183.7);
	this.instance_40._off = true;

	this.face = new lib.rise_up_face();
	this.face.name = "face";
	this.face.setTransform(1266.65,344.8,1.8,1.8,0,0,0,142.6,183.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_40).wait(1196).to({_off:false},0).wait(1).to({regX:141.2,regY:263.3,scaleX:1.0855,scaleY:1.0855,x:1268.65,y:492.05},0).wait(1).to({scaleX:1.1646,scaleY:1.1646,x:1268.15,y:491.6},0).wait(1).to({scaleX:1.2376,scaleY:1.2376,x:1267.65,y:491.2},0).wait(1).to({scaleX:1.3049,scaleY:1.3049,x:1267.25,y:490.85},0).wait(1).to({scaleX:1.3668,scaleY:1.3668,x:1266.85,y:490.5},0).wait(1).to({scaleX:1.4236,scaleY:1.4236,x:1266.45,y:490.15},0).wait(1).to({scaleX:1.4758,scaleY:1.4758,x:1266.2,y:489.85},0).wait(1).to({scaleX:1.5234,scaleY:1.5234,x:1265.85,y:489.55},0).wait(1).to({scaleX:1.567,scaleY:1.567,x:1265.55,y:489.35},0).wait(1).to({scaleX:1.6067,scaleY:1.6067,x:1265.3,y:489.15},0).wait(1).to({scaleX:1.6427,scaleY:1.6427,x:1265.1,y:488.95},0).wait(1).to({scaleX:1.6754,scaleY:1.6754,x:1264.85,y:488.75},0).wait(1).to({scaleX:1.7051,scaleY:1.7051,x:1264.7,y:488.6},0).wait(1).to({scaleX:1.7318,scaleY:1.7318,x:1264.55,y:488.45},0).wait(1).to({scaleX:1.7558,scaleY:1.7558,x:1264.35,y:488.3},0).wait(1).to({scaleX:1.7774,scaleY:1.7774,x:1264.2,y:488.2},0).wait(1).to({scaleX:1.7967,scaleY:1.7967,x:1264.1,y:488.1},0).wait(1).to({scaleX:1.8,scaleY:1.8,y:488.05},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).to({_off:true},1).wait(78));

	// black_eye
	this.instance_41 = new lib.CachedBmp_180();
	this.instance_41.setTransform(1123,350.5,0.5,0.5);
	...
	this.instance_42.setTransform(1266.05,273.85,1,1,0,0,0,146.2,78.9);
	...
	this.instance_43.setTransform(1358.5,549.95,1.2,1.2,0,0,0,556.6,454.7);
	...
	this.instance_44.setTransform(1263.85,527.5,1.499,1.499,-101.5527,0,0,72.8,107.2);
	this.instance_44._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_44).wait(1034).to({_off:false},0).wait(1).to({regX:72.7,regY:0,rotation:-57.0986,x:1128.85,y:440.4},0).wait(1).to({rotation:-12.6442,x:1228.55,y:370.85},0).wait(1).to({rotation:31.8101,x:1348.35,y:391.05},0).wait(1).to({rotation:76.2645,x:1419.8,y:489.35},0).wait(1).to({rotation:37.9689,x:1362.5,y:400.9},0).wait(1).to({rotation:-0.3267,x:1262.8,y:366.95},0).wait(1).to({rotation:-38.6224,x:1163.45,y:402.15},0).wait(1).to({rotation:-76.918,x:1107.25,y:491.3},0).wait(1).to({rotation:-42.5322,x:1155.1,y:409.3},0).wait(1).to({rotation:-8.1465,x:1240.95,y:368.55},0).wait(1).to({rotation:26.2393,x:1334.7,y:383.5},0).wait(1).to({rotation:60.625,x:1403.65,y:448.7},0).wait(1).to({rotation:37.7728,x:1362.1,y:400.55},0).wait(1).to({rotation:14.9207,x:1305.05,y:372.35},0).wait(1).to({rotation:-7.9315,x:1241.5,y:368.5},0).wait(1).to({rotation:-30.7837,x:1181.45,y:389.65},0).wait(1).to({rotation:-15.5201,x:1220.7,y:372.85},0).wait(1).to({rotation:-0.2565,x:1263,y:366.95},0).wait(1).to({rotation:15.0071,x:1305.25,y:372.4},0).wait(1).to({rotation:5.8372,x:1280,y:367.8},0).wait(1).to({rotation:-3.3326,x:1254.35,y:367.2},0).wait(1).to({rotation:-12.5025,x:1228.9,y:370.75},0).wait(1).to({rotation:-2.3707,x:1257.05,y:367.1},0).wait(1).to({rotation:7.7611,x:1285.4,y:368.4},0).wait(1).to({rotation:2.5452,x:1270.8,y:367.1},0).wait(1).to({rotation:-2.6707,x:1256.2},0).wait(1).to({rotation:1.5,x:1267.9,y:367},0).wait(1).to({regX:73.5,regY:107.4,scaleX:1.4989,scaleY:1.4989,rotation:0.0012,x:1263.65,y:527.85},0).to({_off:true},65).wait(200));

	// cut_face
	this.instance_45 = new lib.rise_up_face("synched",0);
	this.instance_45.setTransform(1270.6,412.95,1,1,0,0,0,142.6,183.7);
	this.instance_45.alpha = 0;
	this.instance_45._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_45).wait(1139).to({_off:false},0).wait(1).to({regX:141.2,regY:263.3,x:1269.2,y:492.55,alpha:0.0714},0).wait(1).to({alpha:0.1429},0).wait(1).to({alpha:0.2143},0).wait(1).to({alpha:0.2857},0).wait(1).to({alpha:0.3571},0).wait(1).to({alpha:0.4286},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.5714},0).wait(1).to({alpha:0.6429},0).wait(1).to({alpha:0.7143},0).wait(1).to({alpha:0.7857},0).wait(1).to({alpha:0.8571},0).wait(1).to({alpha:0.9286},0).wait(1).to({alpha:1},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:142.6,regY:183.7,x:1270.6,y:412.95},0).wait(35).to({startPosition:0},0).to({_off:true},1).wait(131));

	// gen_2
	this.instance_46 = new lib.gen();
	this.instance_46.setTransform(1409.9,403.5,1.2,1.2,0,0,0,567.1,294.6);
	this.instance_46._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_46).wait(499).to({_off:false},0).wait(1).to({regX:567.7,regY:294.5,x:1410.6,y:403.35},0).wait(1).to({x:1408.25,y:403.55},0).wait(1).to({x:1393.55,y:404.5},0).wait(1).to({x:1355.6,y:407.1},0).wait(1).to({x:1295.5,y:410.4},0).wait(1).to({x:1224.5,y:407.75},0).wait(1).to({x:1164.05,y:373.8},0).wait(1).to({x:1139.15,y:319.2},0).wait(1).to({x:1126.5,y:268.95},0).wait(1).to({x:1119.8,y:236.3},0).wait(1).to({x:1117.3,y:223.6},0).wait(1).to({x:1116.9,y:221.5},0).wait(1).to({x:1116.85,y:221.35},0).wait(1).to({regY:294.6,x:1116.15,y:221.45},0).wait(14).to({regX:567.6,regY:294.4,x:1116.2},0).wait(1).to({regX:567.7,regY:294.5,x:1116.3,y:221.55},0).wait(1).to({x:1116.6,y:223.35},0).wait(1).to({x:1118.35,y:235.2},0).wait(1).to({x:1123.75,y:273.35},0).wait(1).to({x:1133.9,y:348.25},0).wait(1).to({x:1151.3,y:439.35},0).wait(1).to({x:1206.3,y:481.45},0).wait(1).to({x:1287.2,y:463.2},0).wait(1).to({x:1352.65,y:442.9},0).wait(1).to({x:1386.2,y:432.55},0).wait(1).to({x:1396.7,y:429.35},0).wait(1).to({x:1398.25,y:428.9},0).wait(1).to({x:1398.3,y:428.85},0).wait(1).to({regX:567.5,x:1398.1,y:428.65},0).wait(13).to({regX:567.1,regY:294.6,x:1398.3,y:428.7},0).wait(1).to({regX:567.7,regY:294.5,x:1399,y:428.55},0).wait(1).to({x:1397,y:431.5},0).wait(1).to({x:1386.25,y:447.3},0).wait(1).to({x:1362.45,y:483},0).wait(1).to({x:1328.7,y:532.9},0).wait(1).to({x:1282.55,y:578.45},0).wait(1).to({x:1226.5,y:577.45},0).wait(1).to({x:1177.2,y:554.35},0).wait(1).to({x:1141.45,y:533.85},0).wait(1).to({x:1125.25,y:524.15},0).wait(1).to({x:1122.25,y:522.3},0).wait(1).to({x:1122.1,y:522.2},0).wait(1).to({regX:567.1,regY:294.6,x:1121.25,y:522.3},0).wait(13).to({regX:567.4,x:1121.4},0).wait(1).to({regX:567.7,regY:294.5,x:1121.7,y:522.1},0).wait(1).to({x:1121.55,y:520.4},0).wait(1).to({x:1120.3,y:508.85},0).wait(1).to({x:1117.6,y:472.5},0).wait(1).to({x:1123.45,y:401.4},0).wait(1).to({x:1196.85,y:316.7},0).wait(1).to({x:1301.15,y:284.1},0).wait(1).to({x:1366.25,y:274.3},0).wait(1).to({x:1388.45,y:271.95},0).wait(1).to({x:1391.8,y:271.6},0).wait(1).to({x:1392,y:271.55},0).wait(1).to({regX:567.2,regY:294.6,x:1391.55,y:271.65},0).wait(13).to({regX:566.4,regY:293.8,x:1391.75,y:271.85},0).wait(1).to({regX:567.7,regY:294.5,x:1393.35,y:272.9},0).wait(1).to({x:1395.85,y:277.45},0).wait(1).to({x:1407.95,y:299.65},0).wait(1).to({x:1432.55,y:345.8},0).wait(1).to({x:1464.45,y:418.1},0).wait(1).to({x:1468.55,y:509.25},0).wait(1).to({x:1427.9,y:557.95},0).wait(1).to({x:1384.05,y:581.8},0).wait(1).to({x:1358.4,y:591.65},0).wait(1).to({x:1352.75,y:593.55},0).wait(1).to({x:1352.35,y:593.65},0).wait(1).to({regX:567.5,regY:294.3,x:1350.6,y:592.75},0).wait(12).to({regX:566.9,x:1350.65},0).wait(1).to({regX:567.7,regY:294.5,x:1351.5,y:593},0).wait(1).to({x:1347.35,y:594.3},0).wait(1).to({x:1323.95,y:601.35},0).wait(1).to({x:1270.75,y:613.15},0).wait(1).to({x:1208.15,y:597.35},0).wait(1).to({x:1167.4,y:527.4},0).wait(1).to({x:1140.4,y:474.1},0).wait(1).to({x:1128.5,y:452.7},0).wait(1).to({x:1126.35,y:449},0).wait(1).to({x:1126.25,y:448.85},0).wait(1).to({regX:567.4,regY:294.4,x:1125.4,y:448.7},0).wait(12).to({regX:567.1,x:1125.5,y:448.75},0).wait(1).to({regX:567.7,regY:294.5,x:1126.25},0).wait(1).to({x:1126.65,y:444.4},0).wait(1).to({x:1128.7,y:418.4},0).wait(1).to({x:1130.15,y:359.4},0).wait(1).to({x:1142.35,y:351.8},0).wait(1).to({x:1256.6,y:444.4},0).wait(1).to({x:1364.3,y:489.75},0).wait(1).to({x:1405.35,y:502.1},0).wait(1).to({x:1412.05,y:503.9},0).wait(1).to({x:1412.3,y:503.95},0).wait(1).to({regX:567.1,regY:294.4,x:1411.4,y:503.75},0).wait(11).to({y:503.85},0).wait(1).to({regX:567.7,regY:294.5,x:1412.05,y:504},0).wait(1).to({x:1408.6,y:506.5},0).wait(1).to({x:1387.55,y:520.85},0).wait(1).to({x:1333.5,y:544.7},0).wait(1).to({x:1267,y:493.2},0).wait(1).to({x:1200.6,y:373.55},0).wait(1).to({x:1146.5,y:326.45},0).wait(1).to({x:1125.45,y:314.7},0).wait(1).to({x:1122,y:313.05},0).wait(1).to({x:1121.85,y:312.95},0).wait(1).to({regX:567.1,regY:294.4,x:1121.2,y:312.85},0).wait(10).to({regX:566.1,regY:294.1,x:1121.3,y:312.8},0).wait(1).to({regX:567.7,regY:294.5,x:1123.35,y:313.25},0).wait(1).to({x:1128.5,y:310.8},0).wait(1).to({x:1159.35,y:294.3},0).wait(1).to({x:1233.5,y:237.4},0).wait(1).to({x:1315.6,y:179.6},0).wait(1).to({x:1374.8,y:212.1},0).wait(1).to({x:1399.5,y:232.8},0).wait(1).to({x:1403.6,y:236.45},0).wait(1).to({x:1403.75,y:236.55},0).wait(1).to({regX:566.2,regY:294.3,x:1401.65,y:236.1},0).wait(12).to({regX:565.8,regY:294.1,x:1401.85,y:236.05},0).wait(1).to({regX:567.7,regY:294.5,x:1404.1,y:236.55,alpha:0.9444},0).wait(1).to({y:236.65,alpha:0.8889},0).wait(1).to({x:1404.15,y:237.3,alpha:0.8333},0).wait(1).to({y:239.65,alpha:0.7778},0).wait(1).to({x:1404.05,y:245.9,alpha:0.7222},0).wait(1).to({x:1403.45,y:259.35,alpha:0.6667},0).wait(1).to({x:1400.2,y:284,alpha:0.6111},0).wait(1).to({x:1388.25,y:322.9,alpha:0.5556},0).wait(1).to({x:1351.1,y:373.75,alpha:0.5},0).wait(1).to({x:1292.2,y:408.3,alpha:0.4444},0).wait(1).to({x:1245.75,y:421.35,alpha:0.3889},0).wait(1).to({x:1215.9,y:426.05,alpha:0.3333},0).wait(1).to({x:1199.55,y:427.75,alpha:0.2778},0).wait(1).to({x:1191.9,y:428.3,alpha:0.2222},0).wait(1).to({x:1189.05,y:428.5,alpha:0.1667},0).wait(1).to({x:1188.25,y:428.55,alpha:0.1111},0).wait(1).to({x:1188.15,alpha:0.0556},0).wait(1).to({x:1188.1,alpha:0},0).to({_off:true},1).wait(60).to({_off:false,regX:567.4,regY:294.6,x:1002,y:576.2},0).wait(1).to({regX:567.7,regY:294.5,x:1002.55,alpha:0.125},0).wait(1).to({x:1011,y:580.5,alpha:0.25},0).wait(1).to({x:1066.85,y:605.4,alpha:0.375},0).wait(1).to({x:1244.75,y:630.65,alpha:0.5},0).wait(1).to({x:1377.95,y:550.55,alpha:0.625},0).wait(1).to({x:1406.3,y:510.85,alpha:0.75},0).wait(1).to({x:1410.2,y:504.3,alpha:0.875},0).wait(1).to({x:1410.3,y:504.15,alpha:1},0).wait(1).to({regX:567.8,regY:294.6,x:1409.8,y:504.2},0).wait(9).to({regX:567.1,x:1409.95},0).wait(1).to({regX:567.7,regY:294.5,x:1410.5,y:504.15},0).wait(1).to({x:1404.1,y:507.4},0).wait(1).to({x:1364.35,y:525.95},0).wait(1).to({x:1257.7,y:540.75},0).wait(1).to({x:1163.8,y:471.1},0).wait(1).to({x:1131.95,y:437.7},0).wait(1).to({x:1126.85,y:432.25},0).wait(1).to({x:1126.7,y:432.1},0).wait(1).to({regX:567.5,regY:294.6,x:1125.9,y:432.2},0).wait(9).to({regX:566.4,x:1126},0).wait(1).to({regX:567.7,regY:294.5,x:1127.65,y:431.9},0).wait(1).to({x:1131.9,y:424.2},0).wait(1).to({x:1156.95,y:376.25},0).wait(1).to({x:1223.25,y:265},0).wait(1).to({x:1338.7,y:257.2},0).wait(1).to({x:1393.95,y:272.9},0).wait(1).to({x:1403.3,y:275.85},0).wait(1).to({x:1403.55,y:275.95},0).wait(1).to({regX:566.8,regY:294.7,x:1402,y:276.2},0).wait(9).to({regX:566.1,regY:293.8,x:1402.1,y:276.35},0).wait(1).to({regX:567.7,regY:294.5,x:1403.9,y:277.35},0).wait(1).to({x:1399.35,y:282.6},0).wait(1).to({x:1371.75,y:315.2},0).wait(1).to({x:1294.1,y:386.05},0).wait(1).to({x:1184.2,y:379.2},0).wait(1).to({x:1136.85,y:364},0).wait(1).to({x:1128.95,y:361.25},0).wait(1).to({x:1128.75,y:361.2},0).wait(1).to({regX:566.3,regY:294.2,x:1126.65,y:360.25},0).wait(9).to({regY:293.9,x:1126.7,y:360.4},0).wait(1).to({regX:567.7,regY:294.5,x:1128.35,y:361.05,alpha:0.8},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.2},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(453));

	// po_angliyski_copy
	this.instance_47 = new lib.poangliyski();
	this.instance_47.setTransform(1406.9,407.35,60,60,0,0,0,251.8,40.1);
	this.instance_47.alpha = 0;
	this.instance_47._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_47).wait(939).to({_off:false},0).wait(1).to({regX:94,regY:69.7,scaleX:54.2426,scaleY:54.2426,x:-7153.05,y:2013.25},0).wait(1).to({scaleX:48.7835,scaleY:48.7835,x:-6292.1,y:1851.9,alpha:0.0004},0).wait(1).to({scaleX:43.6136,scaleY:43.6136,x:-5476.75,y:1699.15,alpha:0.0034},0).wait(1).to({scaleX:38.745,scaleY:38.745,x:-4708.9,y:1555.25,alpha:0.0146},0).wait(1).to({scaleX:34.1656,scaleY:34.1656,x:-3986.8,y:1420,alpha:0.0446},0).wait(1).to({scaleX:29.8845,scaleY:29.8845,x:-3311.65,y:1293.45,alpha:0.111},0).wait(1).to({scaleX:25.8986,scaleY:25.8986,x:-2683.1,y:1175.7,alpha:0.24},0).wait(1).to({scaleX:22.208,scaleY:22.208,x:-2100.9,y:1066.6,alpha:0.468},0).wait(1).to({scaleX:18.8156,scaleY:18.8156,x:-1565.75,y:966.4,alpha:0.8434},0).wait(1).to({scaleX:15.7155,scaleY:15.7155,x:-1076.7,y:874.75,alpha:1},0).wait(1).to({scaleX:12.9076,scaleY:12.9076,x:-633.75,y:791.8},0).wait(1).to({scaleX:10.398,scaleY:10.398,x:-237.85,y:717.65},0).wait(1).to({scaleX:8.1866,scaleY:8.1866,x:111,y:652.25},0).wait(1).to({scaleX:6.2645,scaleY:6.2645,x:414.2,y:595.45},0).wait(1).to({scaleX:4.6406,scaleY:4.6406,x:670.3,y:547.45},0).wait(1).to({scaleX:3.315,scaleY:3.315,x:879.45,y:508.3},0).wait(1).to({scaleX:2.2786,scaleY:2.2786,x:1042.95,y:477.65},0).wait(1).to({scaleX:1.5405,scaleY:1.5405,x:1159.35,y:455.8},0).wait(1).to({scaleX:1.0976,scaleY:1.0976,x:1229.25,y:442.75},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:1252.5,y:438.4},0).wait(1).to({regX:252.2,regY:40.9,scaleX:0.89,scaleY:0.89,x:1402.35,y:410.35},0).wait(1).to({regX:94,regY:69.7,scaleX:0.8884,scaleY:0.8884,x:1261.8,y:435.9},0).wait(1).to({scaleX:0.8868,scaleY:0.8868,x:1262.05,y:435.85},0).wait(1).to({scaleX:0.8852,scaleY:0.8852,x:1262.3,y:435.8},0).wait(1).to({scaleX:0.8836,scaleY:0.8836,x:1262.55},0).wait(1).to({scaleX:0.882,scaleY:0.882,x:1262.8,y:435.7},0).wait(1).to({scaleX:0.8804,scaleY:0.8804,x:1263.05,y:435.65},0).wait(1).to({scaleX:0.8788,scaleY:0.8788,x:1263.3},0).wait(1).to({scaleX:0.8772,scaleY:0.8772,x:1263.55,y:435.6},0).wait(1).to({scaleX:0.8756,scaleY:0.8756,x:1263.8,y:435.55},0).wait(1).to({scaleX:0.874,scaleY:0.874,x:1264.05,y:435.5},0).wait(1).to({scaleX:0.8724,scaleY:0.8724,x:1264.3,y:435.45},0).wait(1).to({scaleX:0.8708,scaleY:0.8708,x:1264.55,y:435.4},0).wait(1).to({scaleX:0.8692,scaleY:0.8692,x:1264.8},0).wait(1).to({scaleX:0.8676,scaleY:0.8676,x:1265.1,y:435.3},0).wait(1).to({scaleX:0.866,scaleY:0.866,x:1265.35,y:435.25},0).wait(1).to({scaleX:0.8644,scaleY:0.8644,x:1265.6,y:435.2},0).wait(1).to({scaleX:0.8628,scaleY:0.8628,x:1265.85},0).wait(1).to({scaleX:0.8612,scaleY:0.8612,x:1266.1,y:435.1},0).wait(1).to({scaleX:0.8596,scaleY:0.8596,x:1266.35,y:435.05},0).wait(1).to({scaleX:0.858,scaleY:0.858,x:1266.6},0).wait(1).to({scaleX:0.8564,scaleY:0.8564,x:1266.85,y:435},0).wait(1).to({scaleX:0.8548,scaleY:0.8548,x:1267.1,y:434.95},0).wait(1).to({scaleX:0.8532,scaleY:0.8532,x:1267.35,y:434.9},0).wait(1).to({scaleX:0.8516,scaleY:0.8516,x:1267.6,y:434.85},0).wait(1).to({scaleX:0.85,scaleY:0.85,x:1267.85,y:434.8},0).wait(1).to({regX:252.2,regY:41,scaleX:0.8,scaleY:0.8,x:1402.4,y:410.35},0).wait(1).to({regX:94,regY:69.7,scaleX:0.7385,scaleY:0.7385,x:1285.55,y:431.5},0).wait(1).to({scaleX:0.6769,scaleY:0.6769,x:1295.3,y:429.75},0).wait(1).to({scaleX:0.6154,scaleY:0.6154,x:1305.05,y:428},0).wait(1).to({scaleX:0.5538,scaleY:0.5538,x:1314.75,y:426.2},0).wait(1).to({scaleX:0.4923,scaleY:0.4923,x:1324.5,y:424.45},0).wait(1).to({scaleX:0.4308,scaleY:0.4308,x:1334.25,y:422.65},0).wait(1).to({scaleX:0.3692,scaleY:0.3692,x:1343.95,y:420.95},0).wait(1).to({scaleX:0.3077,scaleY:0.3077,x:1353.7,y:419.15},0).wait(1).to({scaleX:0.2462,scaleY:0.2462,x:1363.45,y:417.4},0).wait(1).to({scaleX:0.1846,scaleY:0.1846,x:1373.15,y:415.6},0).wait(1).to({scaleX:0.1231,scaleY:0.1231,x:1382.9,y:413.9},0).wait(1).to({scaleX:0.0615,scaleY:0.0615,x:1392.65,y:412.1},0).wait(1).to({scaleX:0,scaleY:0,x:-1402.4,y:-410.3},0).wait(2).to({_off:true},1).wait(325));

	// po_angliyski
	this.instance_48 = new lib.imperativemood_2("synched",0);
	this.instance_48.setTransform(972.85,67.7,1.2,1.2,0,0,0,0.1,0);
	...
	this.instance_49.setTransform(943.05,25.4,1.2,1.2);
	...
	this.instance_50.setTransform(300.35,-103.7,1.2,1.2);
	...
	this.instance_51.setTransform(1011.7,-94,1.2,1.2);

	this.instance_52 = new lib.angliyskiy();
	this.instance_52.setTransform(1381.4,230.95,0.336,0.336,0,0,0,252.7,41.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_52).wait(731).to({_off:false},0).wait(1).to({regX:312,regY:34.7,x:1401.3,y:228.6},0).wait(1).to({x:1401.35,y:228.65},0).wait(1).to({x:1401.45},0).wait(1).to({x:1401.95},0).wait(1).to({x:1403.25,y:228.75},0).wait(1).to({x:1406.1,y:228.9},0).wait(1).to({x:1411.55,y:229.2},0).wait(1).to({x:1421.05,y:229.85},0).wait(1).to({x:1436.25,y:231.15},0).wait(1).to({x:1458.55,y:233.6},0).wait(1).to({x:1487.9,y:238.6},0).wait(1).to({x:1519.75,y:248.8},0).wait(1).to({x:1537.35,y:269.6},0).wait(1).to({x:1519.8,y:297.15},0).wait(1).to({x:1487.95,y:319.55},0).wait(1).to({x:1458.55,y:335.75},0).wait(1).to({x:1436.25,y:346.75},0).wait(1).to({x:1421.1,y:353.8},0).wait(1).to({x:1411.55,y:358.1},0).wait(1).to({x:1406.1,y:360.55},0).wait(1).to({x:1403.25,y:361.8},0).wait(1).to({x:1401.95,y:362.35},0).wait(1).to({x:1401.5,y:362.55},0).wait(1).to({x:1401.35,y:362.6},0).wait(2).to({x:1401.3},0).wait(1).to({regX:252.7,regY:41.5,x:1381.35,y:364.9},0).wait(1).to({regX:312,regY:34.7,x:1401.25,y:362.55},0).wait(1).to({x:1401.2,y:362.5},0).wait(1).to({x:1400.85,y:361.85},0).wait(1).to({x:1399.4,y:359.6},0).wait(1).to({x:1395.5,y:353.45},0).wait(1).to({x:1386.95,y:339.9},0).wait(1).to({x:1370.25,y:313.55},0).wait(1).to({x:1353.6,y:287.25},0).wait(1).to({x:1345.05,y:273.7},0).wait(1).to({x:1341.15,y:267.55},0).wait(1).to({x:1339.75,y:265.3},0).wait(1).to({x:1339.35,y:264.65},0).wait(1).to({x:1339.3,y:264.6},0).wait(1).to({x:1339.25,y:264.55},0).wait(1).to({regX:252.7,regY:41.6,x:1319.3,y:266.95},0).wait(22).to({regX:252.6,regY:41.5},0).wait(1).to({regX:312,regY:34.7,x:1339.25,y:264.6,alpha:0.8571},0).wait(1).to({alpha:0.7143},0).wait(1).to({alpha:0.5714},0).wait(1).to({alpha:0.4286},0).wait(1).to({alpha:0.2857},0).wait(1).to({alpha:0.1429},0).wait(1).to({alpha:0},0).wait(4).to({_off:true},1).wait(520));

	// svoi
	this.instance_53 = new lib.svoi("synched",0);
	this.instance_53.setTransform(2354.45,311.9,60,60,0,0,0,248.8,20.1);
	this.instance_53.alpha = 0;
	this.instance_53._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_53).wait(682).to({_off:false},0).wait(1).to({regX:114.5,regY:27.3,scaleX:51.4205,scaleY:51.4207,x:-4600.3,y:680.8},0).wait(1).to({scaleX:43.528,scaleY:43.5285,x:-3589.35,y:622.7,alpha:0.0024},0).wait(1).to({scaleX:36.3226,scaleY:36.3233,x:-2670.7,y:569.5,alpha:0.0194},0).wait(1).to({scaleX:29.7998,scaleY:29.8008,x:-1843.8,y:521.25,alpha:0.0819},0).wait(1).to({scaleX:23.9686,scaleY:23.9697,x:-1109.8,y:478.05,alpha:0.25},0).wait(1).to({scaleX:18.82,scaleY:18.8212,x:-467.5,y:439.8,alpha:0.6223},0).wait(1).to({scaleX:14.3585,scaleY:14.3598,x:82.45,y:406.5,alpha:1},0).wait(1).to({scaleX:10.584,scaleY:10.5855,x:483.55,y:380.2},0).wait(1).to({scaleX:7.4922,scaleY:7.4937,x:793,y:358.85},0).wait(1).to({scaleX:5.0918,scaleY:5.0935,x:1009.45,y:342.5},0).wait(1).to({scaleX:3.3742,scaleY:3.3759,x:1134.25,y:331.1},0).wait(1).to({scaleX:2.3435,scaleY:2.3453,x:1166.75,y:324.7},0).wait(1).to({scaleX:2,scaleY:2.0018,x:1106.95,y:323.25},0).wait(1).to({regX:252.2,regY:40.8,scaleX:0.7227,scaleY:0.7234,x:1224.7,y:308.8},0).wait(1).to({regX:114.5,regY:27.3,x:1125.15,y:299},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:252.2,regY:41.4,x:1224.7,y:308.9},0).wait(1).to({regX:114.5,regY:27.3,x:1125.15,y:298.65},0).wait(1).to({x:1125.2},0).wait(1).to({x:1125.3},0).wait(1).to({x:1125.65},0).wait(1).to({x:1126.65},0).wait(1).to({x:1128.8},0).wait(1).to({x:1133.05},0).wait(1).to({x:1140.55},0).wait(1).to({x:1152.9},0).wait(1).to({x:1172.15},0).wait(1).to({x:1200.8},0).wait(1).to({x:1242},0).wait(1).to({x:1299.5},0).wait(1).to({x:1357},0).wait(1).to({x:1398.25},0).wait(1).to({x:1426.9},0).wait(1).to({x:1446.15},0).wait(1).to({x:1458.5},0).wait(1).to({x:1465.95},0).wait(1).to({x:1470.2},0).wait(1).to({x:1472.4},0).wait(1).to({x:1473.4},0).wait(1).to({x:1473.75},0).wait(1).to({x:1473.85},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:252.7,regY:41.6,scaleX:0.72,scaleY:0.72,x:1573.5,y:308.95,mode:"independent"},0).wait(1).to({regX:114.5,regY:27.3,x:1473.95,y:298.6},0).wait(2).to({x:1473.9,y:298.65},0).wait(1).to({x:1473.65},0).wait(1).to({x:1473},0).wait(1).to({x:1471.55},0).wait(1).to({x:1468.75},0).wait(1).to({x:1463.75},0).wait(1).to({x:1455.6},0).wait(1).to({x:1442.85},0).wait(1).to({x:1423.8},0).wait(1).to({x:1396.45},0).wait(1).to({x:1369.15},0).wait(1).to({x:1350.1},0).wait(1).to({x:1337.35},0).wait(1).to({x:1329.2},0).wait(1).to({x:1324.2},0).wait(1).to({x:1321.4},0).wait(1).to({x:1319.95},0).wait(1).to({x:1319.3},0).wait(1).to({x:1319.05},0).wait(1).to({x:1319},0).wait(2).to({x:1318.95},0).wait(1).to({regX:252.7,regY:41.6,x:1418.5,y:308.95},0).wait(22).to({regX:252.6,x:1418.45},0).wait(1).to({regX:114.5,regY:27.3,x:1330.45,y:298.6,alpha:0.8571},0).wait(1).to({x:1341.9,alpha:0.7143},0).wait(1).to({x:1353.3,alpha:0.5714},0).wait(1).to({x:1364.75,alpha:0.4286},0).wait(1).to({x:1376.15,alpha:0.2857},0).wait(1).to({x:1387.6,alpha:0.1429},0).wait(1).to({x:1399,alpha:0},0).wait(2).to({_off:true},1).wait(520));

	// svoi
	this.instance_54 = new lib.svoi_2("synched",0);
	this.instance_54.setTransform(627.6,-16.15,1.2,1.2,0,0,0,0,-0.1);
	...
	this.instance_55.setTransform(1126.9,162.75,1.2,1.2);

	this.instance_56 = new lib.uderzhi();
	this.instance_56.setTransform(1576.95,488.1,0.48,0.48,0,0,0,252.4,41.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_56).wait(719).to({_off:false},0).wait(1).to({regX:185.6,regY:67.7,x:1544.85,y:500.8},0).wait(1).to({y:500.85},0).wait(1).to({x:1544.7},0).wait(1).to({x:1544.05},0).wait(1).to({x:1542.3,y:500.95},0).wait(1).to({x:1538.45,y:501.15},0).wait(1).to({x:1531.05,y:501.45},0).wait(1).to({x:1518.35,y:501.8},0).wait(1).to({x:1498.35,y:501.85},0).wait(1).to({x:1469.35,y:500.65},0).wait(1).to({x:1431.1,y:495.85},0).wait(1).to({x:1386.5,y:482.7},0).wait(1).to({x:1344.85,y:452.2},0).wait(1).to({x:1327.05,y:407.45},0).wait(1).to({x:1329.05,y:366.6},0).wait(1).to({x:1337.65,y:333.9},0).wait(1).to({x:1346.8,y:309.95},0).wait(1).to({x:1354.05,y:293.75},0).wait(1).to({x:1359,y:283.6},0).wait(1).to({x:1362,y:277.75},0).wait(1).to({x:1363.6,y:274.7},0).wait(1).to({x:1364.3,y:273.3},0).wait(1).to({x:1364.6,y:272.8},0).wait(1).to({x:1364.65,y:272.65},0).wait(2).to({y:272.6},0).wait(1).to({regX:252.4,regY:41.1,x:1396.75,y:259.95},0).wait(1).to({regX:185.6,regY:67.7,x:1364.65,y:272.65},0).wait(1).to({x:1364.7,y:272.7},0).wait(2).to({y:272.85},0).wait(1).to({x:1364.75,y:273.25},0).wait(1).to({x:1364.9,y:274.1},0).wait(1).to({x:1365.2,y:275.75},0).wait(1).to({x:1365.75,y:278.65},0).wait(1).to({x:1366.55,y:283.45},0).wait(1).to({x:1367.9,y:290.95},0).wait(1).to({x:1369.85,y:302.1},0).wait(1).to({x:1372.65,y:318.15},0).wait(1).to({x:1375.5,y:334.25},0).wait(1).to({x:1377.45,y:345.4},0).wait(1).to({x:1378.8,y:352.9},0).wait(1).to({x:1379.6,y:357.7},0).wait(1).to({x:1380.15,y:360.6},0).wait(1).to({x:1380.4,y:362.25},0).wait(1).to({x:1380.55,y:363.1},0).wait(1).to({x:1380.65,y:363.5},0).wait(1).to({y:363.65},0).wait(4).to({regX:252.3,regY:41.1,x:1412.65,y:350.9},0).wait(23).to({regX:185.6,regY:67.7,x:1380.6,y:363.6,alpha:0.8571},0).wait(1).to({alpha:0.7143},0).wait(1).to({alpha:0.5714},0).wait(1).to({alpha:0.4286},0).wait(1).to({alpha:0.2857},0).wait(1).to({alpha:0.1429},0).wait(1).to({alpha:0},0).wait(4).to({_off:true},1).wait(522));

	// present_perfect
	this.instance_57 = new lib.presentperfect_2("synched",0,false);
	this.instance_57.setTransform(963.6,171.2,1.2,1.2);
	...
	this.instance_58.setTransform(539.8,124.5,1.2,1.2);
	...
	this.instance_59.setTransform(913.1,261.35,1.2,1.2,0,0,0,0,0.1);
	...
	this.instance_60.setTransform(1049.9,-62.15,1.2,1.2);
	...
	this.instance_61.setTransform(656.25,203.75,1.2,1.2,0,0,0,0,0.1);
	...
	this.instance_62.setTransform(1095.75,105.95,1.2,1.2,0,0,0,0.1,0.1);
	...
	this.instance_63.setTransform(623,-130.6,1.2,1.2);
	...
	this.instance_64.setTransform(2420.25,155.6,1.2,1.2);
	...
	this.instance_65.setTransform(1277,638.15,1.212,1.212,0,0,0,49.9,45.5);
	this.instance_65._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_65).wait(297).to({_off:false},0).wait(60).to({regY:45.4,x:1277.2,y:638.05},0).wait(1).to({regX:66.9,regY:29,x:1297.75,y:618.15},0).wait(1).to({x:1297.9},0).wait(1).to({x:1299,y:617.9},0).wait(1).to({x:1302.8,y:617},0).wait(1).to({x:1312.5,y:614.35},0).wait(1).to({x:1330.85,y:607.7},0).wait(1).to({x:1354.7,y:591.1},0).wait(1).to({x:1365.7,y:548},0).wait(1).to({x:1362.9,y:487.8},0).wait(1).to({x:1368.2,y:448.2},0).wait(1).to({x:1374.75,y:426.8},0).wait(1).to({x:1378.65,y:417},0).wait(1).to({x:1380.25,y:413.35},0).wait(1).to({x:1380.7,y:412.35},0).wait(1).to({x:1380.75,y:412.2},0).wait(2).to({regX:49.9,regY:45.5,x:1360.1,y:432.1},0).wait(1).to({regX:66.9,regY:29,x:1380.65,y:412.05},0).wait(2).to({x:1380.5},0).wait(1).to({x:1380},0).wait(1).to({x:1378.55},0).wait(1).to({x:1375.4},0).wait(1).to({x:1369.3},0).wait(1).to({x:1358.45},0).wait(1).to({x:1340.65},0).wait(1).to({x:1315.75},0).wait(1).to({x:1297.95},0).wait(1).to({x:1287.15},0).wait(1).to({x:1281},0).wait(1).to({x:1277.85},0).wait(1).to({x:1276.4},0).wait(1).to({x:1275.9},0).wait(1).to({x:1275.75},0).wait(2).to({x:1275.7},0).wait(1).to({regX:50,regY:45.5,scaleX:1.2119,scaleY:1.2119,x:1255.25,y:432.05},0).wait(53).to({regX:49.9,regY:45.4,scaleX:1.212,scaleY:1.212,x:1215.05,y:432},0).wait(1).to({regX:66.9,regY:29,x:1235.6,y:412.1,alpha:0.875},0).wait(1).to({alpha:0.75},0).wait(1).to({alpha:0.625},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.375},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.125},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(871));

	// znaniya
	this.instance_66 = new lib.znaniya();
	this.instance_66.setTransform(1485.6,253,0.6,0.6,0,0,0,270.2,40.1);
	this.instance_66._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_66).wait(309).to({_off:false},0).wait(48).to({regX:270.1,regY:39.9,x:1485.55,y:253.05},0).wait(1).to({regX:116.8,regY:46.7,x:1387.9,y:258.4},0).wait(1).to({x:1382.2,y:259.85},0).wait(1).to({x:1375.95,y:261.55},0).wait(1).to({x:1368.05,y:264},0).wait(1).to({x:1356.4,y:268.15},0).wait(1).to({x:1337.75,y:276.3},0).wait(1).to({x:1308.7,y:293.7},0).wait(1).to({x:1269.15,y:331.8},0).wait(1).to({x:1242.25,y:379.3},0).wait(1).to({x:1232.35,y:410.8},0).wait(1).to({x:1228.6,y:429.95},0).wait(1).to({x:1227.1,y:441.65},0).wait(1).to({x:1226.35,y:449.35},0).wait(1).to({x:1225.95,y:455.4},0).wait(1).to({x:1225.7,y:460.9},0).wait(1).to({x:1225.5,y:466.25},0).wait(1).to({regX:270.1,regY:39.9,x:1317.55,y:462.15},0).wait(1).to({regX:116.8,regY:46.7,x:1225.55,y:466.15},0).wait(1).to({x:1225.6},0).wait(1).to({x:1225.8},0).wait(1).to({x:1226.5},0).wait(1).to({x:1228.5},0).wait(1).to({x:1232.8},0).wait(1).to({x:1241.25},0).wait(1).to({x:1256.15},0).wait(1).to({x:1280.65},0).wait(1).to({x:1314.85},0).wait(1).to({x:1339.35},0).wait(1).to({x:1354.25},0).wait(1).to({x:1362.65},0).wait(1).to({x:1367},0).wait(1).to({x:1368.95},0).wait(1).to({x:1369.7},0).wait(1).to({x:1369.9},0).wait(3).to({regX:270.2,regY:40,x:1461.9,y:462.15},0).wait(5).to({regX:270.1,regY:39.9},0).wait(1).to({regX:116.8,regY:46.7,x:1369.9,y:466.15},0).wait(1).to({rotation:-31.8795,x:1385.9,y:514.2},0).wait(1).to({rotation:-64.1932,x:1425.45,y:546.7},0).wait(1).to({rotation:-120.369,x:1511.9,y:539.45},0).wait(1).to({rotation:-134.544,x:1529.3,y:524.8},0).wait(1).to({rotation:-138.582,x:1533.55,y:519.95},0).wait(1).to({rotation:-133.599,x:1528.25,y:525.95},0).wait(1).to({rotation:-120.369,x:1511.9,y:539.45},0).wait(1).to({rotation:-90,x:1465.95,y:554.05},0).wait(1).to({rotation:-69.9862,x:1434.25,y:549.95},0).wait(1).to({rotation:-62,x:1422.3,y:545.2},0).wait(1).to({rotation:-68.2162,x:1431.5,y:549.05},0).wait(1).to({rotation:-77.1285,x:1445.35,y:552.7},0).wait(1).to({rotation:-90,x:1465.95,y:554.05},0).wait(1).to({rotation:-104,x:1488.1,y:550.35},0).wait(1).to({rotation:-107,x:1492.65,y:548.9},0).wait(1).to({rotation:-104,x:1488.1,y:550.35},0).wait(1).to({rotation:-90,x:1465.95,y:554.05},0).wait(1).to({rotation:-80.2433,x:1450.25,y:553.45},0).wait(1).to({rotation:-77.5558,x:1446.05,y:552.8},0).wait(1).to({rotation:-80.2433,x:1450.25,y:553.45},0).wait(1).to({rotation:-90,x:1465.95,y:554.05},0).wait(1).to({rotation:-95,x:1473.95,y:553.4},0).wait(1).to({rotation:-97,x:1477.1,y:552.95},0).wait(1).to({rotation:-95,x:1473.95,y:553.4},0).wait(1).to({rotation:-90,x:1465.95,y:554.05},0).wait(1).to({rotation:-87.5282,x:1461.95,y:554.2},0).wait(1).to({rotation:-90,x:1465.95,y:554.05},0).wait(1).to({rotation:-92,x:1469.15,y:553.85},0).wait(1).to({rotation:-89,x:1464.3,y:554.2},0).wait(1).to({rotation:-90,x:1465.95,y:554.05},0).wait(1).to({rotation:-91,x:1467.55,y:554},0).wait(1).to({rotation:-90,x:1465.95,y:554.05},0).wait(1).to({regX:270.2,regY:40,x:1461.85,y:462.1},0).wait(2).to({regX:269.1,regY:39.9,y:462.2},0).wait(1).to({regX:116.8,regY:46.7,x:1465.85,y:560.65},0).wait(1).to({y:582},0).wait(1).to({y:617.7},0).wait(1).to({y:667.5},0).wait(1).to({y:731.65},0).wait(1).to({y:810.15},0).wait(1).to({y:902.75,alpha:0.5},0).wait(1).to({y:938.45,alpha:0},0).wait(1).to({_off:true},1).wait(882));

	// bf2
	this.instance_67 = new lib.big_foots("synched",0);
	this.instance_67.setTransform(1488.8,597.1,1.2,1.2,0,0,0,556.8,454.7);
	...
	this.instance_68.setTransform(1395.8,465.15,1.2,1.2,0,0,0,483.4,345.2);
	...
	this.instance_69.setTransform(1276.1,614.15,1.212,1.212,0,0,0,50,45.5);
	this.instance_69._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_69).wait(125).to({_off:false},0).wait(60).to({regX:50.1,regY:45.4,x:1276.2,y:614},0).wait(1).to({regX:34.1,regY:51.2,x:1256.8,y:621},0).wait(1).to({x:1256.95},0).wait(1).to({x:1258.05,y:620.75},0).wait(1).to({x:1261.85,y:619.8},0).wait(1).to({x:1271.75,y:617.15},0).wait(1).to({x:1291.25,y:610.2},0).wait(1).to({x:1319.75,y:592.4},0).wait(1).to({x:1344.7,y:545.85},0).wait(1).to({x:1355.95,y:482.2},0).wait(1).to({x:1365.95,y:441.4},0).wait(1).to({x:1373.55,y:419.7},0).wait(1).to({x:1377.65,y:409.85},0).wait(1).to({x:1379.3,y:406.2},0).wait(1).to({x:1379.75,y:405.2},0).wait(1).to({x:1379.8,y:405.05},0).wait(2).to({regX:50.1,regY:45.4,x:1399.2,y:398},0).wait(1).to({regX:34.1,regY:51.2,x:1379.8,y:405},0).wait(2).to({x:1379.75},0).wait(1).to({x:1379.55,y:405.05},0).wait(1).to({x:1378.95},0).wait(1).to({x:1377.6},0).wait(1).to({x:1375.05},0).wait(1).to({x:1370.5},0).wait(1).to({x:1363.05},0).wait(1).to({x:1352.6},0).wait(1).to({x:1345.15},0).wait(1).to({x:1340.6},0).wait(1).to({x:1338.05},0).wait(1).to({x:1336.7},0).wait(1).to({x:1336.1},0).wait(1).to({x:1335.9},0).wait(1).to({x:1335.85},0).wait(2).to({x:1335.8},0).wait(1).to({regX:50.1,regY:45.4,scaleX:1.2119,scaleY:1.2119,x:1355.1,y:398},0).wait(51).to({scaleX:1.212,scaleY:1.212,x:1355.2},0).wait(1).to({regX:34.1,regY:51.2,x:1335.8,y:405,alpha:0.9333},0).wait(1).to({alpha:0.8667},0).wait(1).to({alpha:0.8},0).wait(1).to({alpha:0.7333},0).wait(1).to({alpha:0.6667},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.5333},0).wait(1).to({alpha:0.4667},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.3333},0).wait(1).to({alpha:0.2667},0).wait(1).to({alpha:0.2},0).wait(1).to({alpha:0.1333},0).wait(1).to({alpha:0.0667},0).wait(1).to({alpha:0},0).wait(8).to({_off:true},1).wait(1030));

	// angliiskiy
	this.instance_70 = new lib.angliiskiy();
	this.instance_70.setTransform(1503.7,259,0.8,0.8,0,0,0,270.2,40);
	this.instance_70._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_70).wait(137).to({_off:false},0).wait(49).to({regX:101.2,regY:45,x:1362.85,y:264.3},0).wait(1).to({x:1357.25,y:265.7},0).wait(1).to({x:1351.2,y:267.4},0).wait(1).to({x:1343.75,y:269.75},0).wait(1).to({x:1332.95,y:273.75},0).wait(1).to({x:1316.4,y:281.55},0).wait(1).to({x:1292.6,y:298},0).wait(1).to({x:1264.6,y:334.1},0).wait(1).to({x:1249.2,y:379.55},0).wait(1).to({x:1244.5,y:410.15},0).wait(1).to({x:1242.95,y:428.95},0).wait(1).to({x:1242.3,y:440.45},0).wait(1).to({x:1241.95,y:448.15},0).wait(1).to({x:1241.75,y:454.1},0).wait(1).to({x:1241.6,y:459.6},0).wait(1).to({x:1241.45,y:464.95},0).wait(1).to({regX:270.2,regY:40,x:1376.75,y:461},0).wait(1).to({regX:101.2,regY:45,x:1241.5,y:464.95},0).wait(1).to({x:1241.55},0).wait(1).to({x:1241.7},0).wait(1).to({x:1242.35},0).wait(1).to({x:1244},0).wait(1).to({x:1247.75},0).wait(1).to({x:1255},0).wait(1).to({x:1267.75},0).wait(1).to({x:1288.8},0).wait(1).to({x:1318.15},0).wait(1).to({x:1339.2},0).wait(1).to({x:1352},0).wait(1).to({x:1359.25},0).wait(1).to({x:1362.95},0).wait(1).to({x:1364.65},0).wait(1).to({x:1365.3},0).wait(1).to({x:1365.45},0).wait(3).to({regX:270.2,regY:40,x:1500.65,y:460.95},0).wait(51).to({y:461},0).wait(1).to({regX:101.2,regY:45,x:1365.45,y:464.95,alpha:0.9333},0).wait(1).to({alpha:0.8667},0).wait(1).to({alpha:0.8},0).wait(1).to({alpha:0.7333},0).wait(1).to({alpha:0.6667},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.5333},0).wait(1).to({alpha:0.4667},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.3333},0).wait(1).to({alpha:0.2667},0).wait(1).to({alpha:0.2},0).wait(1).to({alpha:0.1333},0).wait(1).to({alpha:0.0667},0).wait(1).to({alpha:0},0).wait(8).to({_off:true},1).wait(1030));

	// bf1
	this.instance_71 = new lib.big_foots("synched",0);
	this.instance_71.setTransform(1472.25,597.1,1.2,1.2,0,0,0,556.6,454.7);
	...
	this.instance_72.setTransform(1395.45,465.45,1.2,1.2,0,0,0,483.1,345.4);
	...
	this.instance_73.setTransform(982.6,32.05,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-47651.9,-5104.1,81001.9,15155.6);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"../images/generator_fraz_promo_atlas_2.png", id:"generator_fraz_promo_atlas_2"},
		{src:"../images/generator_fraz_promo_atlas_3.png", id:"generator_fraz_promo_atlas_3"},
		{src:"../sounds/hat.mp3", id:"hat"},
