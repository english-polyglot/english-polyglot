...
function adBlockDetected() {
	...
	var	ifr='<iframe id="instr" style="visibility:hidden" class="infront" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" vspace="0" hspace="0" name="internal"></iframe>';

	var adcont='<div id="progress2"><div class="info0"><div class="info"><span> &nbsp;</span><br /><span>Пожалуйста, отключите блокиратор рекламы...</span><br /><span> &nbsp;</span></div><a class="adblock__button"';
	
	var aAll = ' href="stop-block.html" target="internal" onclick="if (clog) {clearTimeout(clog)};">как отключить</a></div>';
	...
	if (b && a) {b.innerHTML= adcont+aAll}
	else if (b && !a) {b.innerHTML= adcont+aFirst+aAll+ifr}
