...
//			 };	 
			...
			var newwin=window.open(url, '_blank', params);
			newwin.onload = function(){this.document.head.innerHTML+='<meta name="viewport" content="width=device-width, user-scalable=no">';
			this.document.body.innerHTML+='<p></p><form style="font-size:150%; text-align:center;"><input type="button" value="   Done   " onClick="setTimeout(function() { window.close(); },50);" /></form><p></p>';};
