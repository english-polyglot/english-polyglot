...
if (ua.match(/iPhone|iPod|Android|Blackberry.*WebKit/i)) 
{
	...
	if (url=="")
	{
			...
			{
				 newwin.document.head.innerHTML ='<meta name="viewport" content="width=device-width, user-scalable=no">'
				 newwin.document.body.innerHTML = '<div style="font-family: Arial, Helvetica, sans-serif; font-size:75%; text-align:center;"><div style="background:url(img/li-uncolorer-rt.gif) no-repeat right top #e5f2ee;">'+
