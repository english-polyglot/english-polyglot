function popup(url, width, height, windowtitle, textdescription, pronunciation) 
{
		...
		if (ua.match(/iPhone|iPod|Android|Blackberry.*WebKit/i)) 
		{
			...
			if (url=="")
			{
					...
					newwin.onload = function() 
					{
						 ...
						 newwin.document.body.innerHTML = '<div style="font-family: Arial, Helvetica, sans-serif; font-size:150%; text-align:center;"><div style="background:url(img/li-uncolorer-rt.gif) no-repeat right top #e5f2ee;">'+
			...
			{		
						...
						if((getextension(url)=='jpg')||(getextension(url)=='gif')||(getextension(url)=='png'))
						{
							...
							{					
								...
								newwin.document.body.innerHTML = '<img src="'+url+
							 '" style="height:100%">'+
		...
		{						
			...
			newwin = window.open('answer.html','_blank',params);
...
var adcont='<div id="progress2"><div class="info0"><div class="info"><span> &nbsp;</span><br /><span>Пожалуйста, отключите блокиратор рекламы...</span><br /><span> &nbsp;</span></div></div></div>';
if (adblocker) {
...
//var pixel=document.getElementById('t').style.imageRendering=this.value
//var pixel2=document.getElementById('t').className+=' pixelate';	

//---------------начало скроллинга

//var to_top=document.createElement('button'),
//	donate=document.createElement('form');
//	
//	to_top.classList.add('scroll-to-top');
//	to_top.classList.add('scroll-to-top--hidden');
//	document.body.appendChild(to_top);
	...
	var to_top=document.getElementById('stt'),
		...
		to_top.innerHTML='';
		//document.getElementsByTagName(body).className='a';
		//to_top.style.display='none';
		//don_btn.style.display='none';
		to_top.className="scroll-to-top fixed-hidden";
		don_btn.className="donateButton fixed-hidden2";
		//setTimeout(function(){to_top.style.display=don_btn.style.display='';document.body.className="preload2"},1000)
		
	//	setTimeout(function(){document.body.className="preload2"},1000)
//		window.onload = function(){
//			document.body.className = "preload2";
//		}
