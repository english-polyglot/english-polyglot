  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      var i =
        ...
        c = function () {
          for (
            var t = {}, e = Array.prototype.slice.call(arguments), n = 0;
            n < e.length;
            n++
          ) {
            var i = e[n];
        ...
        s = function (t) {
          ...
          for (e = r.length - 1; e >= 0; e--)
            (o = r[e]) &&
              ...
              ((u = o.name.substr(5).replace(/-./g, c)), (n[u] = o.value));
          return n;
        },
        l = function (t) {
          var e = {},
        ...
        v = (function () {
          function t() {
            return (
              i(this, t),
              console.warn(
                "likely function is DEPRECATED and will be removed in 3.0. Use likely.initiate instead."
              ),
            ...
            r(t, null, [
              {
                ...
                value: function () {
                  return (
                    console.warn(
                      "likely.initate function is DEPRECATED and will be removed in 3.0. Use likely.initiate instead."
                    ),
                    t.initiate.apply(t, arguments)
                  );
                },
            ...
            s(t, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e ||
                    (e = Object.keys(a.a).filter(function (e) {
                      return t.classList.contains(e);
                    })[0]),
                    e &&
                      ((this.service = e), n.i(o.extend)(this.options, a.a[e]));
                },
              },
              {
                key: "detectParams",
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  e ||
                    this.options.zeroes ||
                    ((c.className += " " + u.default.prefix + "counter_empty"),
                    (c.content = "")),
                    this.widget.appendChild(
                      n.i(r.createNode)(n.i(o.template)(l, c))
                    ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (t.click.call(this)) {
                    ...
                    if (!1 === t.openPopup)
                      return (
                        n.i(r.createTempLink)(this.addAdditionalParamsToUrl(e)),
                        !1
                      );
                    n.i(r.openPopup)(
                      this.addAdditionalParamsToUrl(e),
                      u.default.prefix + this.service,
                      t.popupWidth,
                      t.popupHeight
                    );
                  }
              ...
              },
              {
                ...
                value: function (t) {
                  var e = n.i(o.query)(
                      n.i(o.merge)(this.widget.dataset, this.options.data)
                    ),
                    i = -1 === t.indexOf("?") ? "?" : "&";
                  return "" === e ? t : t + i + e;
                },
      ...
      var i = n(1),
        r = function (t, e) {
          ...
          n.i(i.getJSON)(t, function (t) {
            try {
              var n =
                "function" == typeof r.convertNumber ? r.convertNumber(t) : t;
              e(n);
            } catch (t) {}
          });
        };
    ...
    function (t, e, n) {
      ...
      e.a = {
        ...
        popupHeight: 500,
        svgIconPath:
          "15.117 0H.883C.395 0 0 .395 0 .883v14.234c0 .488.395.883.883.883h7.663V9.804H6.46V7.39h2.086V5.607c0-2.066 1.262-3.19 3.106-3.19.883 0 1.642.064 1.863.094v2.16h-1.28c-1 0-1.195.48-1.195 1.18v1.54h2.39l-.31 2.42h-2.08V16h4.077c.488 0 .883-.395.883-.883V.883C16 .395 15.605 0 15.117 0",
      };
    },
    function (t, e, n) {
      "use strict";
        ...
        counter: function (t, e, n) {
          ...
          i.open("POST", t),
            ...
            i.addEventListener("load", function () {
              var t = JSON.parse(i.responseText)[0].result.metadata.globalCounts
                .count;
              e(t);
            }),
            i.send(
    ...
    function (t, e, n) {
      ...
      e.a = {
        counterUrl:
          "https://www.linkedin.com/countserv/count/share?url={url}&format=jsonp&callback=?",
        convertNumber: function (t) {
          return t.count;
        },
        popupUrl:
    ...
    function (t, e, n) {
      ...
      var i = n(1),
        ...
        o = {
          counterUrl:
            "https://connect.ok.ru/dk?st.cmd=extLike&ref={url}&uid={index}",
    ...
    function (t, e, n) {
      ...
      e.a = {
        ...
        popupHeight: 500,
        svgIconPath:
          "6,11.960784l-1,-3l11,-8l-15.378,5.914c0,0 -0.672,0.23 -0.619,0.655c0.053,0.425 0.602,0.619 0.602,0.619l3.575,1.203l1.62,5.154l2.742,-2.411l-0.007,-0.005l3.607,2.766c0.973,0.425 1.327,-0.46 1.327,-0.46l2.531,-13.435l-10,11z",
      };
    },
    function (t, e, n) {
      "use strict";
            ...
            c(t, [
              {
                ...
                value: function () {
                  n
                    .i(u.toArray)(this.container.children)
              ...
              },
              {
                key: "update",
                value: function (t) {
                  (t.forceUpdate || (t.url && t.url !== this.options.url)) &&
