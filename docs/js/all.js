...
if (root) {
  if (root.addEventListener) {
    ...
    root.addEventListener("load", processOnload, false);
  } else if (root.attachEvent) {
    root.attachEvent("onload", tooltip.d);
    root.attachEvent("onload", processOnload);
  }
}
...
css_code +=
  ".hh1::before{height:75px;transform:translate(5%,-50%);width:90%;mix-blend-mode:multiply}";
...
css_code +=
  ".one-1.line_1_2{color:transparent}.one-1.line_1_2 span{color: inherit;}";
css_code +=
  "@media(min-width:320px){.hh1{width:210px}.hh1::before{height:80px}.hh1::after{width:80px}}";
css_code +=
  "@media(min-width:425px){.hh1{width:250px}.hh1::before{height:100px}.hh1::after{width:100px}}";
css_code +=
  "@media(min-width:616px){.hh1{width:210px}.hh1::before{height:90px}.hh1::after{width:90px}}";
