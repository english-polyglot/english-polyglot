...
var intro = [
  ...
  '<span class="intro1"' +
    ...
    '">' +
    x_bottom +
    "Переведите фразу в уме. Нажмите стрелку снова, чтобы проконтролировать ваш перевод.</span>",
  '<span class="intro1"' +
    x_code +
    '">' +
    x_top +
  ...
  '<span class="intro1"' +
    ...
    '">' +
    x_bottom2 +
    "Ниже отображается таблица глаголов. Спрятать/показать её можно кнопкой с крестиком.</span>",
  '<span class="intro1"' +
    x_code +
    '">' +
    x_bottom +
    "Кнопкой под фразами можно выбрать глагол.</span>",
  '<span class="intro1"' +
    x_code +
    '">' +
    x_top +
    "Другие настройки генератора фраз находятся в верхнем меню.</span>",
  '<span class="intro1"' +
    x_code +
    '">' +
    x_top +
    "В верхнем меню находятся остальные инструкции по работе с генератором фраз.</span>",
];

var ij3 =
  '<span id="ij3"><span class="intro1" onclick="disappear();appear()">' +
  x_bottom2 +
  "</em>Ниже отображается таблица глаголов. Спрятать/показать её можно кнопкой с крестиком.</span></span>";
...
function block(gen, name, loc) {
  ...
  document.getElementById("progress_line").style.background =
    "rgb(120,120,120)";
  switch (gen) {
    case 1:
      {
  ...
  if (number_click == 1) {
    ...
    if (first == "a") {
      data_top =
        "<em>" +
        c1 +
        '</em><span><a id="hierarhy" href="javascript: void(0)" onclick="playWord3(message_top, currentVerb);if(i==2){disappear();appear()}">' +
        message_top +
        "</a></span>";

      if (sound & phrase_audio & sound_global) {
        playWord3(message_top, currentVerb);
      }
      ...
      data_top =
        "<em>" +
        c1 +
        '</em><span><a id="hierarhy2" href="javascript: void(0)" onclick="playWord3(mesmid, currentVerb, message_top);if(i==2){disappear();appear()}">' +
        message_top +
        "</a></span>";

      if (sound & phrase_audio & sound_global) {
        playWord3(mesmid, currentVerb, message_top);
      }
    ...
    if (first == "a") {
      ...
      data_bot =
        "<em>" +
        c3 +
        '</em><span><a id="hierarhy2" href="javascript: void(0)" onclick="playWord3(mesmid2, currentVerb, message_bottom);if(i==2){disappear();appear()}">' +
        message_bottom +
        "</a></span>";

      if (sound & translation_audio & sound_global) {
        playWord3(mesmid2, currentVerb, message_bottom);
      }
      ...
      data_mid =
        "<em>" +
        c3 +
        '</em><span><a id="hierarhy" href="javascript: void(0)" onclick="playWord3(message_middle, currentVerb);if(i==2){disappear();appear()}">' +
        message_middle +
        "</a></span>";

      if (sound & translation_audio & sound_global) {
        playWord3(message_middle, currentVerb);
      }
...
function preload_pap(pap) {
  ...
  function processConcatenatedFile(dataSound) {
    ...
    if (pap == currentVerb) {
      document.getElementById("progress_line").style.background = "#3C8C3E";
    }
  }
