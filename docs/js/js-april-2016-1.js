...
var x =
  '<em id="stop_intro" class="arrow bottom right" onclick="disappear();appear()"></em>';
var intro = [
  '<span class="intro1">' +
    x +
...
var ij3 =
  ...
  x +
  "Таблицу глаголов можно спрятать/показать здесь</span></span>";
var tabl = [
  ,
  [
...
if (adblocker) {
  document.getElementById("page1").innerHTML =
    '<div id="adbl"><div> &nbsp;</div><br /><div class="info adblstop">Please turn off the Adblock on this site and restart the page or browser</div><br /><div> &nbsp;</div></div>';
}
...
function block(gen, name) {
  ...
  if (name.innerHTML) {
    name = name.innerHTML.match(/<aa>(.*?)<\/aa>/g);
  }
